          ...
          {session &&
            <div className="flex flex-col sm:flex-row items-center gap-2">
              <button 
                ...
                className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 sm:px-5 py-2 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mx-2 sm:mx-4 w-full sm:w-auto justify-center sm:justify-start" 
                type="button"
              >
              ...
              <div 
                id="dropdown" 
                className={`z-10 absolute left-0 sm:left-[125px] top-full sm:top-auto
              ...
              <button 
                type="button" 
                className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-3 sm:px-5 py-2 text-center w-full sm:w-auto my-2 sm:my-0" 
                onClick={() => { signOut() }}
              >
                Logout
              </button>
